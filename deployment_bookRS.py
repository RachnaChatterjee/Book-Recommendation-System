# -*- coding: utf-8 -*-
"""
Created on Sun May 14 22:31:12 2023
...
popular = pickle.load(open("C:/Users/HP/Downloads/popular.pkl",'rb'))
books = pickle.load(open("C:/Users/HP/Downloads/books.pkl",'rb'))
pt = pickle.load(open("C:/Users/HP/Downloads/pt.pkl",'rb'))
similarity_score = pickle.load(open("C:/Users/HP/Downloads/similarity_score.pkl",'rb'))

book_list = pt.index.values
image_url = popular['Image-URL-M'].tolist()
book_title = popular['Book-Title'].tolist() 
book_author = popular['Book-Author'].tolist()
total_ratings = popular['num_of_rating'].tolist()
